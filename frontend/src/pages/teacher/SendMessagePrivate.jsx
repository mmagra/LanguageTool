...
const SendMessagePrivate = () => {
    ...
    const Separator = () => (
        <div className="w-px h-5 bg-gray-200 mx-1.5 self-center"></div>
    );
        ...
        return (
            <div className="flex h-[80vh] items-center justify-center p-8 text-center animate-fade-in">
                <div className="max-w-md w-full bg-white p-8 rounded-2xl shadow-xl border border-gray-100">
                    ...
                    <p className="text-gray-500 mb-8 leading-relaxed">Please select a student from your main list to start a private conversation.</p>
                    <button
    ...
    const DetailItem = ({ icon: Icon, label, value }) => (
        <div className="flex items-start gap-3 p-3 rounded-xl hover:bg-gray-50 transition-colors">
            ...
            <div>
                ...
                <p className="text-gray-900 font-medium break-all">{value || 'N/A'}</p>
            </div>
        </div>
    );
    ...
    return (
        <div className="animate-fade-in font-inter h-full">
            ...
            <div className="mb-6 pl-1">
                <h1 className="text-3xl font-bold text-gray-800 tracking-tight">Send Private Message</h1>
                <p className="text-gray-500 text-sm mt-1">Secure confidential communication</p>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 items-stretch">
                ...
                <div className="lg:col-span-1">
                    <div className="bg-white rounded-2xl p-6 shadow-xl shadow-gray-200/50 border border-gray-100 h-full flex flex-col relative overflow-hidden">
                        ...
                        <div className="flex flex-col items-center text-center mb-8 relative">
                            <div className="relative mb-4 group">
                                <div className="w-24 h-24 rounded-full bg-gradient-to-br from-[#2ea3f2] to-[#f2a93b] p-[3px] shadow-lg shadow-primary-500/20 group-hover:shadow-primary-500/40 transition-all duration-500">
                                    <div className="w-full h-full rounded-full bg-white flex items-center justify-center relative overflow-hidden">
                                        {student.profile_image ? (
                                            ...
                                            <>
                                                <div className="absolute inset-0 bg-gradient-to-br from-[#e3f2fd] to-[#fff3e0] opacity-50"></div>
                                                <span className="text-3xl font-bold bg-clip-text text-transparent bg-gradient-to-br from-[#2ea3f2] to-[#f2a93b] relative z-10">
                            ...
                            <h2 className="text-xl font-bold text-gray-900 mb-1">{student.first_name} {student.last_name}</h2>
                ...
                <div className="lg:col-span-2">
                    <div className="bg-white rounded-2xl shadow-xl shadow-gray-200/50 border border-gray-100 backdrop-blur-sm overflow-hidden relative h-[650px] flex flex-col">
                        {sentSuccess ? (
                            <div className="absolute inset-0 z-50 bg-white/90 backdrop-blur-sm flex items-center justify-center animate-in fade-in duration-300">
                                <div className="text-center p-8">
                                    ...
                                    <p className="text-gray-500">Your secure message has been delivered.</p>
                                </div>
                            </div>
                        ) : null}
                            ...
                            <div className="p-4 border-t border-gray-100 bg-gray-50/30 flex items-center justify-between shrink-0">
                                <button
                                    ...
                                    className={`flex items-center gap-2 px-4 py-2.5 rounded-xl transition-all duration-300 font-medium text-sm ${isListening
                                        ...
                                        : 'bg-white text-gray-600 hover:text-primary-600 hover:bg-white border border-gray-200 hover:border-primary-100 shadow-sm hover:shadow-md'
                                        }`}
                                >
                                ...
                                <button
                                    ...
                                    className={`inline-flex items-center gap-2 px-8 py-3 bg-gradient-to-r from-primary-600 to-primary-700 text-white font-bold rounded-xl text-sm
