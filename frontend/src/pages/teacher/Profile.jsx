...
import {
    ...
    Globe, Briefcase, Award, Clock, FileText, AlertCircle, Camera, Check, Trash2, Building
} from 'lucide-react';
                ...
                {error && (
                    <div className="mb-6 bg-red-50 border border-red-200 rounded-xl p-4 flex items-start gap-3">
                        ...
                        <div>
                            ...
                            <button onClick={fetchTeacherData} className="mt-3 px-4 py-2 bg-red-600 text-white rounded-lg hover:bg-red-700 transition-colors text-sm font-semibold">Try Again</button>
                        </div>
                    </div>
                )}
                    ...
                    <div className="bg-[#f0f4fe] p-6 md:p-8 relative">
                        <div className="flex flex-col md:flex-row items-center md:items-start gap-6 text-center md:text-left">
                            ...
                            <div className="flex-1 min-w-0">
                                ...
                                <p className="text-gray-600 font-medium mb-2 break-all">{teacherData.email}</p>
