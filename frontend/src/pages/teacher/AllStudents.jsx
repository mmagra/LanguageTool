        ...
        <ProtectedRoute roles={['teacher']}>
            <div className="space-y-6 animate-fade-in">
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                    <div>
                        <h1 className="text-3xl font-bold text-gray-800 tracking-tight">View All Students</h1>
                        <p className="text-gray-500 text-sm mt-1">Select a student to send a private message.</p>
                    </div>
                </div>
