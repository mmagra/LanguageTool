        ...
        <ProtectedRoute roles={['admin']}>
            <div className="space-y-6">
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-6">
                    <div>
                        <h1 className="text-xl font-semibold tracking-tight text-slate-900">New Users Permissions</h1>
                        <p className="text-slate-500 text-sm mt-1">Manage pending account approval requests.</p>
                    </div>
                </div>
                    ...
                    <div className="overflow-x-auto">
                        {loading ? (
                            ...
                            <div className="flex flex-col items-center justify-center h-64 text-slate-500">
                                ...
                                <p className="text-sm text-slate-600">All users have been processed.</p>
                            </div>
                        ) : (
                                ...
                                <tbody className="bg-white divide-y divide-slate-100">
                                    {currentUsers.map((user) => (
                                        ...
                                        >
                                            ...
                                            <td className="px-6 py-4 whitespace-nowrap">
                                                <span className={`px-2.5 py-1 inline-flex text-xs leading-5 font-semibold rounded-full border ${user.role === 'student' ? 'bg-blue-100 text-blue-800 border-blue-200' :
                                                    user.role === 'teacher' ? 'bg-emerald-100 text-emerald-800 border-emerald-200' :
