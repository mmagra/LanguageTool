        ...
        <ProtectedRoute roles={['admin']}>
            <div className="space-y-6">
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-6">
                    <div>
                        <h1 className="text-3xl font-bold text-gray-800 tracking-tight">Denied Users</h1>
                        <p className="text-gray-500 text-sm mt-1">Review and manage denied account requests.</p>
                    </div>
                </div>
                    ...
                    <div className="overflow-x-auto">
                        {loading ? (
                            ...
                            <div className="flex flex-col items-center justify-center h-64 text-gray-500">
                                ...
                                <p className="text-lg font-bold text-gray-900 mb-1">No denied users found</p>
                                <p className="text-sm text-gray-600">Your denial list is clean.</p>
                            </div>
                        ) : (
