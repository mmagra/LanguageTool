...
const Profile = () => {
    ...
    const fetchAdminData = async () => {
        try {
            ...
            if (response.success) {
                ...
                const lastName = admin.last_name || admin.lastName || user.lastName || '';
    ...
    const handleCancel = () => {
        ...
        if (adminData) {
            setFormData({
                first_name: adminData.first_name || adminData.firstName || user.firstName || '',
                last_name: adminData.last_name || adminData.lastName || user.lastName || '',
                ...
                {error && (
                    <div className="mb-6 bg-red-50 border border-red-200 rounded-xl p-4 flex items-start gap-3">
                        ...
                        <div>
                            ...
                            <button onClick={fetchAdminData} className="mt-3 px-4 py-2 bg-red-600 text-white rounded-lg hover:bg-red-700 transition-colors text-sm font-semibold">Try Again</button>
                        </div>
                    </div>
                )}
