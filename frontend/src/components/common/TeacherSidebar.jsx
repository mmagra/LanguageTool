...
const TeacherSidebar = ({ collapsed, onCollapseChange, onClose }) => {
  ...
  const logoSectionHeight = 'h-[72.5px]';
  ...
  const menuItems = [
    ...
    },
    {
      ...
      label: 'View Students',
      submenu: [
        { label: 'View all Students', path: '/teacher/students' },
        { label: 'Send Group Message', path: '/teacher/group-message' }
      ]
    },
    {
      id: 'conversations',
    ...
    {
      id: 'in-person',
      icon: UserCheck, // Or another relevant icon like Users, Calendar, etc.
      label: 'In Person Communication',
      path: '/teacher/in-person'
    },
  ];
              ...
              <div className="ml-4 pl-4 border-l border-gray-200 mt-2 mb-2 space-y-1">
                {item.submenu.map((subItem, subIndex) => (
                  <NavLink
                    ...
                    onClick={(e) => {
                      e.preventDefault();
                      requestNavigation(subItem.path);
                      onClose();
                    }}
                  >
  ...
  return (
    <>
      <div
        className={`flex flex-col h-full bg-white border-r border-gray-100 text-gray-900 transition-all duration-300 ${collapsed ? 'w-20' : 'w-[17rem]'
          }`}
      >
        {/* Sidebar Header */}
              ...
              <div className="w-full flex items-center justify-center">
                <img
                  ...
                  onError={(e) => {
                    ...
                    fallback.innerHTML = '<span class="font-bold text-primary-600 text-2xl">Spoken Edge</span>';
              ...
              <div className="w-full flex items-center justify-center">
                <img
                  ...
                  onError={(e) => {
                    ...
                    fallback.innerHTML = '<span class="font-bold text-primary-600">SE</span>';
                    e.target.parentElement.appendChild(fallback);
                  }}
                />
              </div>
